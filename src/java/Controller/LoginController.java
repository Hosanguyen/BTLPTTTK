...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println("Loading... " + username + " " + password);
            NguoiDung376 nguoiDung = new LoginDAO().checkLogin(username, password);
            if(nguoiDung != null){
                ...
                response.sendRedirect("GDLogin376.jsp?error=Invalid username or password");
            }
        } catch(Exception e){
            e.printStackTrace();
        }
